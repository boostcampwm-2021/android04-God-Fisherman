...
class HomeViewModel @Inject constructor(
    ...
    private val _rankList: MutableLiveData<List<HomeRankingData>> by lazy { MutableLiveData<List<HomeRankingData>>() }
    val rankList: LiveData<List<HomeRankingData>> = _rankList
